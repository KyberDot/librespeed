pipeline {
  ...
  environment {
    ...
    BUILD_VERSION_ARG = 'LIBRESPEED_RELEASE'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-librespeed'
    DOCKERHUB_IMAGE = 'linuxserver/librespeed'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/librespeed'
    PR_DOCKERHUB_IMAGE = 'lspipepr/librespeed'
    DIST_IMAGE = 'alpine'
    MULTIARCH='true'
    CI='true'
    CI_WEB='true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-librespeed/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-librespeed\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-librespeed\" \
